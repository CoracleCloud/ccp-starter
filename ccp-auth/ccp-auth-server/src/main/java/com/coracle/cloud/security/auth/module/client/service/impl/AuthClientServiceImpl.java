...
import com.coracle.cloud.security.auth.module.client.service.AuthClientService;
import com.coracle.cloud.security.auth.module.client.bean.ClientInfo;
...
import com.coracle.cloud.security.auth.jwt.client.ClientTokenUtil;
import com.coracle.cloud.security.common.exception.auth.ClientInvalidException;
...
public class AuthClientServiceImpl implements AuthClientService {
    ...
    private Client getClient(String clientId, String secret) {
        ...
        if(client==null){
            throw new ClientInvalidException("Client not found!");
        }
        if(!client.getSecret().equals(secret)){
            throw new ClientInvalidException("Client secret is error!");
        }
        return client;
    }
